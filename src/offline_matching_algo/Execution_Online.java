...
setIconImage(iicon.getImage());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        consumer=new boolean[Online.consumer];
        display=new int[Online.consumer];
        time=0;
       ...
       for(int i=0;i<Preference_List_Online.stages;i++)
		{
			...
			{
				for(int k=0;k<Online.consumer;k++)
				{
					if(consumer[k])
					{
				...
				if(Online3.arrivalTime[Preference_List1_Online.resourceList[i][j]-1]<=time && Online3.arrivalTime[Preference_List1_Online.requestList[i][j]-1]<=time && (Online4.maxDelay[Preference_List1_Online.resourceList[i][j]-1]+Online3.arrivalTime[Preference_List1_Online.resourceList[i][j]-1]>=time))
				{
            ...
            add(l1);
            JLabel l2;
            for(int p=0;p<Online.consumer;p++)
            {
                if(display[p]==-1)
                {
